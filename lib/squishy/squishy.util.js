...
define([], function() {
     ...
     */
    squishy.extendClass = function(baseClass, ctor, methods) {
        // create extended class ctor with additional checks
     ...
     * 
     */
    squishy.makeEnum = function(_obj, methods) {
        var nameTable = {};
        var values = [];
     ...
     */
    squishy.forEachOwnProp = function(object, callback) {
        for (var propName in object) {
            if (!object.hasOwnProperty(propName)) continue;
            callback(propName, object[propName]);
        };
    };
    ...
    squishy.getCurrentTimeMillisHighRes = (function() {
        if (performance.now) {
            return function() { return performance.now(); s};
        } else {
